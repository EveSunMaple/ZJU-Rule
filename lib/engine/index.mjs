...
import { buildClashConfig, customRulesToClash, dedupeRules } from './clash.mjs';
...
export async function convert(request, ctx = {}) {
  ...
  const meta = {
    ...
    ruleCount: remapped.rules.length,
  ...
  /* --- Clash 配置 --- */
  const basePath = profile.base.clash
